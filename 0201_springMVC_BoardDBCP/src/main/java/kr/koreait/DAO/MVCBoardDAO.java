...
import org.springframework.jdbc.core.PreparedStatementSetter;import org.springframework.jdbc.core.RowMapper;
...
public class MVCBoardDAO {
	...
	public void insert(final String name,final String title,final String content){
		...
		/*	첫번째 방법
		Object [] obj ={name, title, content};
		template.update(sql, obj);*/
		
/*	두번째 방법
 * 		template.update(sql, name, title, content);*/
	...
	public MVCBoardVO view(int num){
		...
		String sql= "select * from mvc_board where idx = "+num;
	...
	*/
	...
	//답변글쓰기폼에서 넘어온 데이터 처리
	public void replyOK(final int idx, final String name, final String title, final String content, final int ref, final int step, final int indent){
